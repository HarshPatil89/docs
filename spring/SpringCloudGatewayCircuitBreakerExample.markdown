...
**Usage**: Boots the Eureka server, enabling it to register and manage client services. The `@EnableEurekaServer` annotation activates Eureka’s service discovery features.
